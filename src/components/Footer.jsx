    ...
    <div style={{height:'300px',color:'white'}} className='d-flex justify-content-center align-items-center w-100 flex-column bg-primary'>
      <div className='d-flex justify-content-evenly align-items-center w-100'>
        <div className="websites" style={{width:'400px'}}>
          <h4 className='mb-3' style={{overflow:'hidden'}}>
          <i class="fa-solid fa-cart-shopping me-2"></i>
          E-CART
          </h4>
          <h6>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Non fugit libero, laboriosam culpa facere odit expedita voluptatem ipsam dolore necessitatibus consectetur laborum eos doloremque nesciunt, provident voluptatibus. Quod, officiis porro?
          </h6>
          <h6>similiagg? ddgchh, tdgfhny</h6>
        </div>
        ...
        <div className="guides d-flex flex-column">
          <h4 className='mb-3' style={{overflow:'hidden'}}>Guides</h4>
        ...
        <h4 className='mb-3' style={{overflow:'hidden'}}>Contact Us</h4>
      ...
      <p className='mt-5'>Copyright @ 2023 Media Player.Builts with React.</p>
    </div>
  )
}
